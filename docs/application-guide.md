...
> 项目名：`gold-etf-analyzer` ｜ 当前版本：V0.11（待发布）
> 命题：面向个人黄金投资者，三市场对照（纽约金/上海金/黄金ETF）+ 趋势评估指数 + 持仓跟踪 + ETF购买决策
...
| **V0.11**（待发布） | AKShare 数据源、2 个月趋势追踪、趋势评估指数、可视化页面、**个人交易跟踪（持仓/盈亏）、购买决策引擎、ETF vs 克价对照、纽约金 60 天曲线、指数置顶+运算方法展示**、41 测试 |
...
| # | 事项 | 状态 | 价值 |
|---|------|------|------|
| 1 | 发布 **V0.11**（commit + `v0.11.0` 标签推送 GitHub） | ⏳ | 固化 AKShare/趋势/指数/交易面/决策/对照/纽约金 |
