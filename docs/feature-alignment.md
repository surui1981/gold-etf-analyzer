...
**测试数对账**：README 标 216 ✅ 与 `find tests/test_*.py` 一致（25 文件）。
...
| **6.8** | **新手引导与帮助** | 🟢 待规划 | ❌ | ⚠️ 未做 |
| **6.9** | **加载与离线体验** | 🟡 中 | ⚠️ 有进度条，**无 Service Worker 离线缓存** | ⚠️ 部分 |
| **6.10** | **央行购金数据化与自动化** | ✅ V0.57.0 | ✅ | ✅ |

---

## 四、文档自身不一致（V0.57.0 同步已完成）

| # | 原问题 | 修复 |
|---|---|---|
| 1 | `application-guide.md` 头部版本号 V0.53.0 | ✅ 已升 V0.57.0 |
| 2 | `application-guide.md` 第 10 章缺 V0.54–V0.57 四条 + 表格列错位 | ✅ 已补齐，统一 5 列格式 |
| 3 | `improvement-path.md` 头部版本号 V0.56.0 | ✅ 已升 V0.57.0 |
| 4 | `improvement-path.md` 实施路线表缺 V0.57.0 行 + 6.10 节 | ✅ 已补 |
| 5 | 三文档测试数不一致（67/214 残留） | ✅ 统一 216 |
| 6 | `application-guide.md` 第 2 章功能清单缺央行购金/调度 | ✅ 已补 |
